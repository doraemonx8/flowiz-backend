        ...
        for (const agent of agents){
            ...
            switch(agent){
                ...
                case "email":
                    ...
                    const emailSubFlowId=await saveSubFlowToDB(JSON.stringify(emailGeneratedData),slug,"1",userId);
                ...
                case "web":
                    ...
                    if(!isWebFlow){
                        ...
                        const chatSubFlowId=await saveSubFlowToDB(JSON.stringify(chatGeneratedData),slug,"2",userId);
                ...
                case "call":
                    ...
                    if(!isCallFlow){
                        ...
                        const callSubFlowId=await saveSubFlowToDB(JSON.stringify(callGeneratedData),slug,"3",userId);
                ...
                case "whatsapp":
                    ...
                    if(!isWhatsAppFlow){
                        ...
                        const whatsAppSubFlowId=await saveSubFlowToDB(JSON.stringify(generatedData),slug,"4",userId);
